...
function showTempleInfo(jsonObj){
    ...
    for (templesindex = 0; templesindex < temples.length; templesindex++){
        ...
        if (temples[templesindex].name == "Chicago, IL")
...
let apiURLstring = "https://api.openweathermap.org/data/2.5/weather?id=4887398&units=imperial&APPID=5a2cf03763628f501603892cdc61ae1d"
